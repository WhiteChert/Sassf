GetLastVersionSoft(URL) { 
	...
	oHTTP.SetTimeouts(6000,6000,6000,6000)
	...
	if(oHTTP.ResponseText = "") {
		SiteResultNoWorking := Object("status", "error", "code", "-1", "msg", "Сайт проверки обновлений не доступен.")
		return JSON.Encode(SiteResultNoWorking)
	} else {
